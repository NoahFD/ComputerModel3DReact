...
import { useGLTF, PerspectiveCamera, RenderTexture, Text } from '@react-three/drei';
...
function ScreenText({ x = 0, y = 1.2, ...props }) {
    ...
    return (
        <Screen {...props}>
            ...
            <Text font="/Inter-Medium.woff" position={[x, y, 0]} ref={textRef} fontSize={4} letterSpacing={-0.1} color='white'>
                Poimandres.
            </Text>
        </Screen>
    );
    ...
    return (
        <group {...props} dispose={null}>
            ...
            <mesh
                ...
                material={nodes.MouseCable.material}
            ...
            <mesh
                ...
                material={nodes.PCPoint.material}
                position={[1.272, 0.712, -2.003]}
            />
            <mesh
                castShadow
