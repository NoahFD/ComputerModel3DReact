...
function App() {
  ...
  //     <Canvas camera={{ position: [0, 10, 0], fov: 55 }} shadows dpr={[1, 1.5]}>
  ...
  return (
    <div style={{ width: "100vw", height: "100vh" }}>
      <Canvas camera={{ position: [0, 0, 0], fov: 50 }} shadows dpr={[1, 1.5]}>
        <Scene showChatBot={showChatBot} handleStartClick={handleStartClick} />
      </Canvas>
    </div>
  );
}
